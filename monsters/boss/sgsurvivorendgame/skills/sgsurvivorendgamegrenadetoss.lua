sgsurvivorendgamegrenadetoss = {}

--------------------------------------------------------------------------------
function sgsurvivorendgamegrenadetoss.enter()
  if not hasTarget() then return nil end

  return {
    windupTimer = config.getParameter("sgsurvivorendgamegrenadetoss.windupTime"),
    winddownTimer = config.getParameter("sgsurvivorendgamegrenadetoss.winddownTime"),
    distanceRange = config.getParameter("sgsurvivorendgamegrenadetoss.distanceRange"),
    skillTimer = 0,
    skillDuration = config.getParameter("sgsurvivorendgamegrenadetoss.skillDuration"),
    angleCycle = config.getParameter("sgsurvivorendgamegrenadetoss.angleCycle"),
    fireTimer = 0,
    fireInterval = config.getParameter("sgsurvivorendgamegrenadetoss.fireInterval"),
    fireAngle = 0,
    maxFireAngle = config.getParameter("sgsurvivorendgamegrenadetoss.maxFireAngle"),
...
--------------------------------------------------------------------------------
function sgsurvivorendgamegrenadetoss.enteringState(stateData)
  animator.setAnimationState("movement", "idle")

  monster.setActiveSkillName("sgsurvivorendgamegrenadetoss")
end

--------------------------------------------------------------------------------
function sgsurvivorendgamegrenadetoss.update(dt, stateData)
  ...
  if stateData.windupTimer > 0 then
    if stateData.windupTimer == config.getParameter("sgsurvivorendgamegrenadetoss.windupTime") then
  ...
  mcontroller.controlParameters({
    walkSpeed = config.getParameter("sgsurvivorendgamegrenadetoss.moveSpeed"),
    runSpeed = config.getParameter("sgsurvivorendgamegrenadetoss.moveSpeed")  
  })
  ...
  if stateData.skillTimer > stateData.skillDuration then
    ...
    if stateData.winddownTimer > 0 then
      if stateData.winddownTimer == config.getParameter("sgsurvivorendgamegrenadetoss.winddownTime") then
  ...
  sgsurvivorendgamegrenadetoss.controlFace(dt, stateData, targetDir)
  ...
  if stateData.fireTimer <= 0 then
    ...
    sgsurvivorendgamegrenadetoss.fire(aimVector)
...
function sgsurvivorendgamegrenadetoss.controlFace(dt, stateData, direction)
  if direction ~= mcontroller.facingDirection() and stateData.facingTimer > 0 then
    stateData.facingTimer = stateData.facingTimer - dt
  else
    stateData.facingTimer = config.getParameter("sgsurvivorendgamegrenadetoss.changeFacingTime")
    mcontroller.controlFace(direction)
  end
end

function sgsurvivorendgamegrenadetoss.fire(aimVector)
  local projectileType = config.getParameter("sgsurvivorendgamegrenadetoss.projectile.type")
  local projectileConfig = config.getParameter("sgsurvivorendgamegrenadetoss.projectile.config")
...
function sgsurvivorendgamegrenadetoss.leavingState(stateData)
  animator.setAnimationState("flameSound", "off")
  animator.setAnimationState("flamethrower", "winddown")
