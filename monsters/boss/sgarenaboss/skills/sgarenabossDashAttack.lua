...
--------------------------------------------------------------------------------
function sgarenabossDashAttack.enter()
  ...
  return {
    edgeDistance = config.getParameter("sgarenabossDashAttack.edgeDistance"),
    dashDistance = config.getParameter("sgarenabossDashAttack.dashDistance"),
    dashSpeed = config.getParameter("sgarenabossDashAttack.dashSpeed"),
    windupTimer = config.getParameter("sgarenabossDashAttack.windupTime"),
    direction = util.randomDirection(),
    dashes = 0,
    dashing = false,
    maxDashes = maxDashes,
    stunned = false,
    stunTime = config.getParameter("sgarenabossDashAttack.stunTime")
  }
end

--------------------------------------------------------------------------------
function sgarenabossDashAttack.enteringState(stateData)
  ...
  monster.setActiveSkillName("sgarenabossDashAttack")
end

--------------------------------------------------------------------------------
function sgarenabossDashAttack.update(dt, stateData)
  ...
  elseif stateData.dashing then
    ...
    if stateData.windupTimer == config.getParameter("sgarenabossDashAttack.windupTime") then
    ...
    if stateData.windupTimer > 0 then
      ...
      sgarenabossDashAttack.performDash(stateData, approachPoint, -stateData.direction)
    end
...
function sgarenabossDashAttack.performDash(stateData, startPosition, direction)
  ...
  if toDashPoint[1] * direction < 0 or wallBlock then
    ...
    stateData.windupTimer = config.getParameter("sgarenabossDashAttack.windupTime")
...
function sgarenabossDashAttack.leavingState(stateData)
