...
function autoFire()
  ...
  while true do
    ...
    aimVector = vec2.rotate(aimVector, sb.nrand(config.getParameter("inaccuracy"), 0)) world.spawnProjectile("sgturretflak", firePosition(), entity.id(), aimVector, false, projectileParameters)
