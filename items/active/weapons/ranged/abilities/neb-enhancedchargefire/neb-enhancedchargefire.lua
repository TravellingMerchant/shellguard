...
NebsEnhancedChargeFire = WeaponAbility:new()

function NebsEnhancedChargeFire:init()
...
function NebsEnhancedChargeFire:update(dt, fireMode, shiftHeld)
...
function NebsEnhancedChargeFire:charge()
...
function NebsEnhancedChargeFire:single()
...
function NebsEnhancedChargeFire:burst()
  if self.chargeLevel.chargeMuzzleOffset then
	self.useChargeMuzzleOffset = true
  end
...
function NebsEnhancedChargeFire:cooldown(duration)
...
function NebsEnhancedChargeFire:muzzleFlash()
...
function NebsEnhancedChargeFire:fireProjectile()
...
function NebsEnhancedChargeFire:firePosition()
...
function NebsEnhancedChargeFire:aimVector(angleAdjust, inaccuracy)
  local aimVector = vec2.rotate({1, 0}, self.weapon.aimAngle + angleAdjust + sb.nrand(inaccuracy, 0))
  aimVector[1] = aimVector[1] * mcontroller.facingDirection()
  return aimVector
end

function NebsEnhancedChargeFire:currentChargeLevel()
...
function NebsEnhancedChargeFire:uninit()
